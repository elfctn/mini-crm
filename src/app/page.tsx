    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 sm:py-6 space-y-4 sm:space-y-0">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-xl sm:text-2xl font-bold text-blue-600">Mini CRM</h1>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-32 text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            ...
            <span className="block text-blue-600">İşinizi Büyütün</span>
          </h2>
      ...
      <footer className="bg-white mt-32">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900">Mini CRM</h3>
