...
// ana sayfa bileşeni - landing page ve yönlendirme mantığı
export default function Home() {
  const router = useRouter();
  const { user, loading } = useAuth();

  // kullanıcı giriş yapmışsa customers sayfasına yönlendir - otomatik yönlendirme
  useEffect(() => {
    if (!loading && user) {
  ...
  // loading durumunda spinner göster - veri yüklenirken
  if (loading) {
    return (
  ...
  // kullanıcı giriş yapmışsa yönlendirme spinner'ı göster - geçiş animasyonu
  if (user) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
      {/* header bölümü - navigasyon ve logo */}
      <header className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 sm:py-6 space-y-4 sm:space-y-0">
            ...
            {/* navigasyon butonları - giriş ve kayıt */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* özellikler bölümü - grid layout ile kartlar */}
        <div className="mt-32">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {/* özellik kartı 1 - müşteri yönetimi */}
            ...
            {/* özellik kartı 3 - arama ve filtreleme */}
            ...
            {/* özellik kartı 4 - profil güncelleme */}
        ...
        {/* son call to action bölümü - kayıt teşviki */}
